...
export const tourDataWithEffect = [
  {
    type: "floating",
  ...
  },
  {
    ...
    title: "Step 1. Controls",
    description: "Use them to change the context properties",
    target: () => document.querySelector(".toolbar nav button:nth-child(1)"),
    actions: [
      {
        label: "Prev",
        action: "prev",
  ...
  },
  {
    ...
    target: () => document.querySelector(".toolbar nav button:nth-child(2)"),
    actions: [
      {
        label: "Prev",
        action: "prev",
  ...
  },
  {
    ...
    target: () =>
      document.querySelector(".toolbar [data-content][data-active]"),
...
export const tourData = [
  ...
  },
  {
    ...
    target: () => {
      ...
      return frameEl?.document.querySelector("#step-2a");
    },
    actions: [
      {
        label: "Prev",
