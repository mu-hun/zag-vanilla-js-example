export const applications = [
  ...
  },
  {
    name: "app-books",
    title: "Books",
    description: "Read and manage books",
  },
  {
    name: "app-calculator",
    title: "Calculator",
...
export const extensions = [
  {
    ...
    commands: [
      {
        name: "cmd-calendar-my-schedule",
        title: "My Schedule",
        description: "View your schedule",
      },
      {
        name: "cmd-calendar-create-event",
        title: "Create Event",
        description: "Create a new event",
      },
      {
        name: "cmd-calendar-edit-event",
        title: "Edit Event",
  ...
  },
  {
    ...
    commands: [
      ...
      {
        name: "cmd-color-picker-organize-colors",
        title: "Organize Colors",
        description: "Manage color palettes",
      },
      {
        name: "cmd-color-picker-pick",
        title: "Pick Color",
  ...
  },
  {
    ...
    commands: [
      {
        name: "cmd-developer-create-extension",
  ...
  },
  {
    ...
    commands: [
      ...
      {
        name: "cmd-ai-create-ai-command",
        title: "Create AI Command",
        description: "Create custom AI commands",
      },
      {
        name: "cmd-ai-import-ai-commands",
        title: "Import AI Commands",
        description: "Import predefined AI commands",
      },
      {
      ...
      {
        name: "cmd-ai-send-to-ai-chat",
        title: "Send to AI Chat",
        description: "Send text to AI chat for processing",
      },
      {
      ...
      {
        name: "cmd-ai-improve-writing",
        title: "Improve Writing",
        description: "Get suggestions to improve writing",
      },
    ],
  },
];
