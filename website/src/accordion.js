...
export class Accordion extends Component {
  ...
  get items() {
    return Array.from(this.rootEl.querySelectorAll(".accordion-item"));
  }
  renderItem = (itemEl) => {
    const value = itemEl.dataset.value;
    if (!value) throw new Error("Expected value to be defined");
    const itemTriggerEl = itemEl.querySelector(".accordion-trigger");
    const itemContentEl = itemEl.querySelector(".accordion-content");
